...
const hints = {
  ...
  "GraphQL": [
    "Facebook: GraphQL was developed by Facebook in 2012 and released as an open-source project in 2015.",
    "API Query Language: GraphQL is a query language for APIs and a runtime for executing those queries with your existing data.",
    "Single Endpoint: Unlike REST, which exposes multiple endpoints, GraphQL exposes a single endpoint for all data queries.",
    "Strongly Typed: GraphQL is strongly typed, allowing clients to specify the structure of the response they want.",
    "Real-time Data: Supports real-time data updates through subscriptions.",
    "Introspection: GraphQL APIs are self-documenting, allowing clients to query the schema for available types and fields.",
    "Ecosystem: Has a rich ecosystem of tools and libraries for various programming languages.",
    "Teeinblue: GraphQL is used by Teeinblue since beginning (I absolutely h...love it).",
  ],
  "TilingWindowManager": [
    "XMonad: TWM is a window manager for the X Window System, which is a graphical user interface system for Unix-like operating systems.",
    "Workspaces: TWM supports workspaces, allowing users to organize their windows into different virtual desktops.",
    "Layout Management: TWM manages the layout of windows on the screen, allowing users to tile and arrange them in a non-overlapping manner.",
    "Keyboard Shortcuts: TWM supports keyboard shortcuts for window management, allowing users to quickly switch between windows and workspaces.",
    "Customizable: TWM is highly customizable, allowing users to configure its behavior and appearance.",
    "Lightweight: TWM is lightweight and efficient, making it suitable for low-resource environments.",
  ],
  "ViImproved": [
    "Bill Joy: VI was created by Bill Joy in 1976",
    "Bram Moolenaar: VIM was created by Bram Moolenaar in 1991 as an improved version of the vi editor.",
    "Modes: VIM has multiple modes, including normal mode, insert mode, visual mode, and command mode.",
    "Keyboard Shortcuts: VIM relies heavily on keyboard shortcuts for navigation and editing.",
    "Extensibility: VIM is highly extensible and customizable through plugins and scripts.",
    "Terminal: VIM is a terminal-based text editor, making it suitable for remote editing over SSH.",
    "Community: VIM has a large and active community, with many resources, tutorials, and plugins available.",
    "EMACS: VIM is often compared to EMACS, another popular text editor, which is using Ctrl key all the time.",
  ],
  "Docker": [
    "Solomon Hykes: Docker was created by Solomon Hykes in 2013.",
    "Containerization: Docker is a platform for developing, shipping, and running applications in containers.",
    "Isolation: Docker containers provide process isolation, allowing applications to run in their own environments.",
    "Portability: Docker containers can run on any system that supports Docker, making them portable across different environments.",
    "Microservices: Docker is often used in microservices architectures to package and deploy services independently.",
    "Ecosystem: Docker has a rich ecosystem of tools and libraries, including Docker Compose, Docker Swarm, and Kubernetes.",
    "Open Source: Docker is an open-source project with a large community of contributors.",
    "Container Registry: Docker Hub is a public container registry for sharing and distributing Docker images.",
  ],
  "ContentDeliveryNetwork": [
    "Caching: CDNs cache content at edge locations to reduce latency and improve load times.",
    "Global Reach: CDNs have a global presence, allowing content to be delivered quickly to users around the world.",
    "Load Balancing: CDNs can distribute traffic across multiple servers to ensure high availability and reliability.",
